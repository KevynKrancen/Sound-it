...
def load_data(path: str): 
    ...
    #file_name = path.split('\\')[-1].split('.')[0]
    video_path = os.path.join('/Users/kevynkrancenblum/Desktop/Data Science/Final Project/LipNet-main/data/s1',f'{file_name}.mpg')
    alignment_path = os.path.join('/Users/kevynkrancenblum/Desktop/Data Science/Final Project/LipNet-main/data/alignments/s1',f'{file_name}.align')
